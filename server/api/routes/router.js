...
router.route('/userExpense/search/:userid')
    .get(expenseController.search_expense_record)

router.route('/userRevenue/search/:userid')
    .get(revenueController.search_revenue_record)  
